                ...
                <form id="contactForm" name="sentMessage" novalidate="novalidate" method="post" action="">
                    <div class="control-group">
                        <div class="form-group floating-label-form-group controls mb-0 pb-2">
							...
							<input class="form-control" name="course_name" id="course_name" type="text" placeholder="Course Name" required="required" data-validation-required-message="Please enter course name." aria-invalid="false">
                        </div>
                    </div>
