...
<head>
    ...
    <title>Student course score</title>
...
<section class="page-section" id="contact">
    <div class="container">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">students courses & scores</h2>
        <!-- Icon Divider-->
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
				...
				<table class="table">
					...
					<tbody>
					<?php foreach ($allScores as $key=>$row){ ?>
					<tr>
						<th scope="row"><?= $key ?></th>
						<td><?= $row->student_name ?></td>
						<td><?= $row->student_dob ?></td>
						<td><?= $row->course_name ?></td>
						<td><?= $row->course_score ?></td>
					</tr>
					<?php } ?>
					</tbody>
				</table>
